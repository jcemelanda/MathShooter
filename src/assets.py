...
class SoundAssets(NamedTuple):
    laser: Union[pygame.mixer.Sound, _DummySound]
    explosion: Union[pygame.mixer.Sound, _DummySound]
    background_music: Optional[pygame.mixer.music]
...
def load_image(name: str, colorkey: Optional[Union[int, pygame.Color]] = None) -> pygame.Surface:
...
def load_sound(name: str) -> Union[pygame.mixer.Sound, _DummySound]:
...
def load_music(name: str) -> Optional[pygame.mixer.music]:
