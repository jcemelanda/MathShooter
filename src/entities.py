...
import assets
from config import (
    PLAYER_START_POS, PLAYER_SPEED, LASER_SPEED, LASER_COOLDOWN,
    ENEMY_MIN_SPEED, ENEMY_MAX_SPEED
)
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self, game: "Game"):
        ...
        text_color = (random.randrange(50, 255),
    ...
    def setValue(self) -> None:
        ...
        if correct_val + 3 > 10:
            self.text = str(random.choice(list(range(int(1.5 * correct_val))) + [correct_val] * correct_val))
        else:
